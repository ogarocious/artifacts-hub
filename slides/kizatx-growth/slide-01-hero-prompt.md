# Kiz ATX Growth Carousel — Slide 1 Hero (AI image gen prompt)
...
4. **Headline (~15% from top, left-aligned, three stacked lines, fills roughly rows 2–5 of an implicit grid).** Massive condensed all-caps display type in the Anton / Impact / Bebas Neue family. Weight ultra-black. Letter-spacing tight (about -0.01em). Line-height very tight (about 0.9 — the lines nearly touch).
